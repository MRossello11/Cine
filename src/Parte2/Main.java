...
public class Main {
    public static void main(String[] args) {
        ...
        Cine c1 = new Cine("Ocimax", 100, 40); //crear objeto c1
        ...
        System.out.println("Dinero recolectado: " + Cine.getDineroRecolectado() + " euros");
        System.out.println("Precio por asiento: " + Asiento.getPrecio());
